...
export default {
    ...
    Mutation: {
        createPost: combineResolvers(isAuthenticated, async (parent, args, { me, models }, info) => {
        ...
        deletePost: combineResolvers(isAuthenticated, async (parent, args, { me, models }, info) => {
